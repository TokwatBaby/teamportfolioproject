...
function AboutUs() {
    return (
        <div className="aboutus flex-col justify-items-center items-center">
            <div className="relative w-3/4 mx-auto border-t-4 text-gray-600 min-h-[30rem] flex items-start justify-center pt-20">
                ...
                {/* "About Us" in front */}
                <p className="relative z-10 text-center gradient-text1 text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-inter font-bold translate-y-20">
                    ABOUT US
                </p>
            </div>
